                                ...
                                <div class="col shadow py-2">
                                    ...
                                    @if ($switch == 'false')
                                        <div class="h6 bg-light p-2 rounded w-25 mt-1 shadow-sm text-danger text-center">
                                            <span class="d-none d-md-inline">Profile Locked</span>
                                            <i class="fa fa-lock" aria-hidden="true"></i>
                                        </div>
                                    @else
                                        <div class="h6 bg-light p-2 rounded w-25 mt-1 shadow-sm text-success text-center">
                                            <span class="d-none d-md-inline">Profile Unlocked</span> <i class="fa fa-unlock"
                                                aria-hidden="true"></i>
                                        </div>
                                    @endif
                                    ...
                                    <div class="form-group m-b-10">
                                        <i class="fas fa-user-circle fa-lg me-3 d-none d-lg-inline"></i>
                                    ...
                                    <div class="form-group m-b-10">
                                        <i class="fas fa-envelope fa-lg me-3 d-none d-lg-inline"></i>
                                    ...
                                    <div class="form-group m-b-10">
                                        ...
                                        <i class="fas fa-venus-double  me-3 d-none d-lg-inline"></i>
                                    ...
                                    <div class="form-group m-b-10">
                                        <i class="fas fa-phone fa-lg me-3 d-none d-lg-inline"></i>
                                    ...
                                    <div class="form-group m-b-10 ">
                                        <div class="d-flex m-0 p-0">
                                            <i class="fas fa-location-arrow fa-lg me-3 d-none d-lg-inline  mt-2"></i>
                                    ...
                                    <div class="form-group m-b-10">
                                        <i class="fas fa-tag fa-lg me-3 d-none d-lg-inline"></i>
                                    ...
                                    <div class="form-group m-b-10">
                                        <i class="fa-solid fa-check fa-lg me-3 d-none d-lg-inline"></i>
                                        <input class="form-control w-90 d-inline" type="text" name="role"
                                    ...
                                    <div class="form-group m-b-10">
                                        ...
                                        @if (Auth::user()->created_at == Auth::user()->updated_at)
                                            <i class="far fa-clock fa-lg me-3 text-success d-none d-lg-inline"></i>
                                            <input class="form-control w-90 d-inline" type="text"
                                                value="{{ auth::user()->created_at->format('j - M - Y') }}Created time "
                                                @disabled($switch)>
                                        @else
                                            <i class="far fa-clock fa-lg me-3 text-danger d-none d-lg-inline"></i>
